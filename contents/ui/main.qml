...
Item {
 ...
 PlasmaComponents.ToolButton {
    text: "twitter"
    onClicked: {
        twitterWebView.url = "https://twitter.com/"
    }
}
						...
						PlasmaComponents.ToolButton {
							text: i18n("Debug")
							checkable: true
							checked: twitterWebViewInspector && twitterWebViewInspector.enabled
							...
							onToggled: {
								twitterWebViewInspector.visible = !twitterWebViewInspector.visible;
								twitterWebViewInspector.enabled = visible || twitterWebViewInspector.visible
							}
						}
						...
						PlasmaComponents.ToolButton {
							...
							PlasmaComponents.ToolTip.delay: Kirigami.Units.toolTipDelay
							PlasmaComponents.ToolTip.visible: hovered
							onClicked: twitterWebView.reload();
						}
					...
					RowLayout {
						...
						PlasmaComponents.Button {
							...
							icon.name: "go-next"
							onClicked:  {
								twitterWebView.url = proLinkField.text;
		...
		WebEngineView {
			...
			WebEngineView {
				...
				inspectedView:enabled ? twitterWebView : null
			}
	}
}
